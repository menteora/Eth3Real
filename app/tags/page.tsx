  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-6 md:px-12 max-w-4xl mx-auto">
      ...
      <header className="mb-20">
        <h1 className="text-5xl md:text-7xl font-serif mb-6 italic">Archivio Categorie</h1>
        <p className="text-xl md:text-2xl text-zinc-500 font-serif leading-relaxed">
          Esplora la narrazione attraverso i temi ricorrenti dello spazio bio-digitale.
        </p>
      </header>
